<%@ Page Language="C#" AutoEventWireup="true" Inherits="avt.DynamicFlashRotator.Net.RegCore.WebClient.ActivationWnd" EnableViewState = "true" CodeFile="Activation.aspx.cs" %>
