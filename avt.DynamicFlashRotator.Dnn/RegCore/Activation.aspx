<%@ Page Language="C#" AutoEventWireup="true" Inherits="DnnSharp.DynamicRotator.RegCore.WebClient.ActivationWnd" EnableViewState = "true" Codefile="Activation.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
    <title><%= _RegCoreApp.Info.Name %> Activation</title>
...
<div class = "act_wnd">
    ...
    <div class = "title">Activate <%= _RegCoreApp.Info.Name %></div>
    <div class = "help">
    ...
    <asp:Panel runat = "server" ID = "pnlSuccess" Visible = "false" style ="height: 260px; padding-top: 30px;">
        ...
        <div style = "text-align: left">
            This copy of <%= _RegCoreApp.Info.Name %> has been successfully activated.<br /><br />
