...
namespace DnnSharp.DynamicRotator.RegCore.WebClient
{
    public partial class ActivationWnd : System.Web.UI.Page // PageBase
    {
        ...
        protected void Page_Init(Object Sender, EventArgs args)
        {
            ...
            var instanceProperty = dataType.GetProperty("Instance", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public);
            var instance = instanceProperty != null ? instanceProperty.GetValue(null, null) : Activator.CreateInstance(dataType);

            _hosts = (List<ListItem>)dataType.GetProperty("Hosts").GetValue(instance, null);
        ...
        protected void OnActivate(object Sender, EventArgs args)
        {
            ...
            try {
                _RegCoreClient.Activate(txtRegistrationCode.Text, _RegCoreApp.Info.Code, _RegCoreApp.Info.Version, host, _RegCoreApp.Info.Key);
            } catch (Exception ex) {
                // error
                validateActivation.IsValid = false;
        ...
        protected void OnManualActivate(object Sender, EventArgs args)
        {
            ...
            try {
                _RegCoreClient.Activate(txtRegistrationCode.Text, _RegCoreApp.Info.Code, _RegCoreApp.Info.Version, host, _RegCoreApp.Info.Key, tbActCode.Text.Trim());
            } catch (Exception) {
                // error
