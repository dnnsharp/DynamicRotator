<%@ Page Language="C#" AutoEventWireup="True" Inherits="DnnSharp.DynamicRotator.RegCore.WebClient.UnlockTrial" Codefile="UnlockTrial.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Unlock <%= _RegCoreApp.Info.Name%> 30 Days Trial</title>
...
<body style="background: #fff;">
    ...
    <div class = "act_wnd">
        <div class = "title">Unlock <%= _RegCoreApp.Info.Name%> 30 Days Trial</div>
        <div>
            ...
            <div style="border: 1px solid #108CB2; padding: 10px; background-color:White; margin: 4px; margin-top: 160px;">
                <div>
                    ...
                    <a href = "<%= _RegCoreServer.GetBuyUrl(_RegCoreApp) %>">Purchase a <%= _RegCoreApp.Info.Name %> license here</a>
