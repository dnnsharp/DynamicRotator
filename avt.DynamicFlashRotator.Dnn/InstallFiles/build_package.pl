...
my $dst = "c:\\work\\_releases\\DynamicRotator\\1.1.2\\";
my $packageName = "avt.DynamicRotator.DNN.1.1.2_";
...
chdir($dst);
system("\"c:\\tools\\infozip\\zip.exe\" -r Resources.zip act res *.aspx *.ascx License.txt >>..\\log.txt");
print("done\n");
