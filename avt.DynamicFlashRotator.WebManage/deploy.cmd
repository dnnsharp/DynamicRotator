...
xcopy "%~dp0/RegCore" "%~dp0..\Test.WebApplication\Controls\Rotator\RegCore" /e /s /y /q

copy "%~dp0/ManageRotatorBase.ascx" "%~dp0../avt.DynamicFlashRotator.Dnn/ManageRotatorBase.ascx"
